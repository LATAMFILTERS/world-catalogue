...
CABIN_FILTERS_URL = "https://shop.donaldson.com/store/en-us/search?N=3718375764&Nr=product.language%3AEnglish&catNav=true&st=parts"
LAST_CODE = "P960429"
TOTAL_EXPECTED = 120
...
def run_donaldson_cabin_filters():
    with sync_playwright() as p:
        ...
        print(f"\n{'='*80}")
        print(f"🏆 CABIN_FILTERS SCRAPING COMPLETADO")
        print(f"{'='*80}")
