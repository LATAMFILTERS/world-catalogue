    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            if has_next:
                ...
                print(f"{'='*80}")
                print(f"⏳ Esperando 5 segundos antes de página {page_num + 1}...")
        ...
        with open("hydraulic_filters_results.json", "w", encoding="utf-8") as f:
            json.dump(results, f, indent=4, ensure_ascii=False)

        print(f"\n📁 Guardado en: hydraulic_filters_results.json")
        context.close()
