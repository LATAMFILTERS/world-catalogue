# Knowledge Center Layer 2 Approval

Status: Approved under current ELIMFILTERS governance
...
Specialized solutions: MARINECLEAN™ and DURATECH™.

No additional technology entity may be exposed without first being added to `docs/brand/TECHNOLOGY_REGISTRY.md` and the canonical entity index.
