...
// Fresh source acquisition is authoritative. No cache, prior render or manual screenshot is required.
...
const manifest = {
  ...
  source_acquisition_mode: 'AUTOMATED_OFFICIAL_SOURCE',
  manufacturer_source_evidence_path: source.evidence_path,
  manufacturer_screenshot_path: source.screenshot_path,
  manufacturer_screenshot_role: 'AUTOMATED_AUDIT_EVIDENCE',
