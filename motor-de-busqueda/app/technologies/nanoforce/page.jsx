        ...
        <div className="nf-sec-inner">
          <div className="nf-grid2">
            <div>
              ...
              <p className="nf-p">The NANOFORCE&#x2122; architecture is not a simple barrier. It is a labyrinth of fibers with progressive density that captures microscopic contaminants &mdash; eliminating the risk of erosion in Common Rail injectors and precision hydraulic components worldwide.</p>
              <p className="nf-p">Engineered for the latest generation high-pressure injection systems requiring absolute fuel purity &mdash; delivering 4 micron absolute filtration and +2X service cycles versus conventional filters.</p>
      ...
      <section className="nf-sec">
        <div className="nf-sec-inner">
          ...
          <div className="nf-grid3">
            {[
              {title:'UNIQUE MEDIA', desc:'Synthetic fibers engineered with progressive density gradient to maximize contaminant retention &mdash; capturing particles at 4 microns absolute across the full service interval.'},
              {title:'ZERO MIGRATION', desc:'Stable depth structure prevents particle passage and media migration under high pressure peaks &mdash; maintaining filter integrity in Common Rail injection systems up to 30,000 PSI.'},
              {title:'TOTAL PROTECTION', desc:'Maintains the absolute fuel purity required by the latest generation diesel injection systems &mdash; protecting precision components from contamination-driven erosion and failure.'},
              {title:'HYDRAULIC DEFENSE', desc:'NANOFORCE&#x2122; depth filtration architecture also protects hydraulic circuits &mdash; capturing metallic particles and contaminants before they reach servo valves and precision actuators.'},
              {title:'EXTENDED CAPACITY', desc:'High dirt-holding capacity extends service intervals by up to 2X versus standard filters &mdash; reducing maintenance frequency and total cost of ownership across fleet operations.'},
              {title:'ISO COMPLIANCE', desc:'Certified to ISO 16889 filtration standards &mdash; ensuring contamination control compliance across all heavy-duty fuel and hydraulic system applications worldwide.'},
            ].map((c, i) => (
      ...
      <section className="nf-sec" style={{background:'#000'}}>
        <div className="nf-sec-inner">
          ...
          <div className="nf-protocol-grid">
            {[
              {num:'01', title:'DEPTH FILTRATION', desc:'Progressive density gradient captures contaminants throughout the media depth &mdash; not just on the surface &mdash; maximizing dirt-holding capacity and extending service life significantly.'},
              {num:'02', title:'PRESSURE STABILITY', desc:'Stable fiber structure maintains filter integrity under high-pressure spikes and pulsations &mdash; preventing media collapse and particle migration in demanding injection systems.'},
              {num:'03', title:'INJECTOR DEFENSE', desc:'Absolute 4 micron particle capture protects Common Rail injector nozzles from erosion &mdash; preserving spray pattern geometry and maintaining peak combustion efficiency.'},
            ].map((p, i) => (
