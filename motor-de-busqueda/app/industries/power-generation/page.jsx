    ...
    <div className="pg">
      ...
      <section className="pg-hero">
        <div className="pg-hero-inner">
          ...
          <p className="pg-hero-p">Precision filtration engineered for diesel gensets, gas reciprocating engines, gas turbines, HFO power plants, and combined heat and power installations. Our technology protects fuel systems, turbine lubricant circuits, hydraulic governing systems, and intake air. Precision-matched to OEM specifications across 5,000+ cross-references. Certified to ISO 16889 standards.</p>
        </div>
      </section>
        ...
        <div className="pg-sec-inner">
          <div className="pg-grid2">
            <div>
              ...
              <p className="pg-p">Our power generation filtration range is validated for Caterpillar, Cummins, MTU, Jenbacher, and Wärtsilä reciprocating engine platforms.</p>
      ...
      <section className="pg-cta">
        <div className="pg-cta-inner">
          <div>
            ...
            <p className="pg-cta-p">Access our global database. Search by OEM or part number to find the industrial-grade match for your facility.</p>
          </div>
