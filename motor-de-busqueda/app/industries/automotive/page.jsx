        ...
        <div className="au-sec-inner">
          ...
          <div className="au-grid4">
            {[
              ...
              {label:'Oil Module', title:'SINTRAX™', desc:'Maintains oil viscosity and cleanliness under severe thermal stress in city environments â€” extending engine life and reducing maintenance costs.', featured:false},
              {label:'Fuel Module', title:'NANOFORCE™', desc:'Nanofiber technology designed to eliminate critical contaminants and water in injection systems â€” protecting Common Rail injectors from premature wear.', featured:true},
              {label:'Environmental Health', title:'MICROKAPPA™', desc:'Biological and chemical barrier against allergens and pollutants from urban exhaust â€” safeguarding operator health in light and commercial vehicles.', featured:false},
            ].map((c, i) => (
