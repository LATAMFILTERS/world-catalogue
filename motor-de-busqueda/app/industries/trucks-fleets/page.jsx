...
export default function TrucksFleets() {
  const css = `
    ...
    .tf-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('${WP}/trucks-fleets.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
        ...
        <div className="tf-sec-inner">
          <div className="tf-grid2">
            <div>
              ...
              <p className="tf-p">Commercial fleets face relentless conditions: continuous operation, heavy loads, and demanding maintenance schedules. Our high-capacity filtration technologies are engineered for durability, fuel cleanliness, and extended intervals.</p>
            ...
            <div className="tf-video-wrap">
              <div className="tf-video-inner">
                <video src={`${WP}/fleet-operations.mp4`} autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="tf-cta">
        <div className="tf-cta-inner">
          <div>
            ...
            <p className="tf-cta-p">Access our global database. Search by OEM or part number to find the industrial-grade match for your fleet.</p>
          </div>
