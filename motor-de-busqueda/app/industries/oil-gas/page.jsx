        ...
        <div className="og-sec-inner">
          <div className="og-grid2">
            <div>
              ...
              <p className="og-p">Our extended-interval technologies are validated for Caterpillar, Cummins, MTU, and GE drill rig packages, providing the fuel, lube, hydraulic, and pneumatic protection required to sustain continuous operations.</p>
      ...
      <section className="og-cta">
        <div className="og-cta-inner">
          <div>
            ...
            <p className="og-cta-p">Access our global database. Search by OEM or part number to find the industrial-grade match for your operations.</p>
          </div>
