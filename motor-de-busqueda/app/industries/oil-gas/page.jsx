...
export default function OilGas() {
  const css = `
    ...
    .og-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('https://pub-fee72f3f35274550bd8a47b181823e33.r2.dev/oil-gas.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="og-grid2">
            ...
            <div className="og-video-wrap">
              <div className="og-video-inner">
                <video src="https://pub-fee72f3f35274550bd8a47b181823e33.r2.dev/gas%26oil%20(1).mp4" autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
