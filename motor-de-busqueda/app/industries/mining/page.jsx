      ...
      <section className="mn-sec" style={{background:'#000'}}>
        <div className="mn-sec-inner">
          ...
          <div className="mn-grid3">
            {[
              {label:'Fuel Module', title:'AQUAGUARD™', desc:'Advanced water separation and contamination removal for mine-site diesel fuel systems – protecting Common Rail injection systems in harsh mining environments.'},
              {label:'Lubrication Module', title:'SINTRAX™', desc:'Maintains oil viscosity and cleanliness under continuous high-load mining operations – extending equipment life across underground and surface mining.'},
              {label:'Hydraulic Systems', title:'NANOFORCE™', desc:'Precision stability for hydraulic systems under extreme pressure and mining duty – protecting control systems and mining equipment from mineral dust damage.'},
              {label:'Air Intake', title:'MACROCORE™', desc:'Maximum particle retention for mineral dust protection with zero-bypass technology – maintaining engine air quality in mining environments.'},
              {label:'Cooling Systems', title:'COOLTECH™', desc:'Thermal protection for mining equipment cooling circuits – preventing scale buildup and corrosion in high-load mining engine cooling systems.'},
              {label:'Pneumatic Systems', title:'DRYCORE™', desc:'Moisture elimination from pneumatic systems and air tools – ensuring reliability across all mining platform operations and equipment.'},
            ].map((c, i) => (
