...
export default function Mining() {
  const css = `
    ...
    .mn-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('${WP}/Mining.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
    ...
    <div className="mn">
      ...
      <section className="mn-hero">
        <div className="mn-hero-inner">
          ...
          <p className="mn-hero-p">Precision filtration engineered for ultra-class haul trucks, rope shovels, hydraulic face shovels, underground LHD loaders, and rotary drill rigs. Our technology protects every critical fluid circuit, extending component life and eliminating unplanned downtime. Precision-matched to OEM specifications across 5,000+ cross-references. Certified to ISO 16889 standards.</p>
        </div>
      </section>
        ...
        <div className="mn-sec-inner">
          <div className="mn-grid2">
            <div>
              ...
              <p className="mn-p">Our extended-interval filtration technologies are validated for Caterpillar, Komatsu, Liebherr, and Hitachi mining platforms.</p>
            ...
            <div className="mn-video-wrap">
              <div className="mn-video-inner">
                <video src={`${WP}/mineria.mp4`} autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mn-cta">
        <div className="mn-cta-inner">
          <div>
            ...
            <p className="mn-cta-p">Access our global database. Search by OEM or part number to find the industrial-grade match for your equipment.</p>
          </div>
