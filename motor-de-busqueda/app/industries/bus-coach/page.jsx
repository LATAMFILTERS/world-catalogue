...
export default function BusCoach() {
  const css = `
    ...
    .bc-video:hover video{opacity:0.9;filter:grayscale(0);}
        ...
        <div className="bc-sec-inner">
          ...
          <div className="bc-tech-grid">
            <div className="bc-tech-card">
              <div className="bc-tech-label">MACROCORE&trade; / AIR INTAKE</div>
            ...
            <div className="bc-tech-card">
              <div className="bc-tech-label">AQUAGUARD&trade; / BRAKES</div>
            ...
            <div className="bc-tech-card">
              <div className="bc-tech-label">NANOFORCE&trade; / FUEL</div>
        ...
        <div className="bc-tco-inner">
          <div className="bc-tco-top">
            ...
            <table className="bc-table" style={{maxWidth:'520px',width:'100%'}}>
              ...
              <tbody>
                <tr><td>Stop-and-Go Wear</td><td>High Oil Stress</td><td>SINTRAX&trade; Stability</td></tr>
