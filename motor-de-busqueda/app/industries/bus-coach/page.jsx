...
export default function BusCoach() {
  const css = `
    ...
    .bc-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('${WP}/buses.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="bc-grid2">
            ...
            <div className="bc-video-wrap">
              <div className="bc-video-inner">
                <video src={`${WP}/buses.mp4`} autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
