...
export default function MarineIndustry() {
  const css = `
    ...
    .mi-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('https://cdn.elimfilters.com/marine.png') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="mi-grid2">
            ...
            <div className="mi-video-wrap">
              <div className="mi-video-inner">
                <video src="https://cdn.elimfilters.com/boat.mp4" autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
