...
export default function Railway() {
  const css = `
    ...
    .ry-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('https://cdn.elimfilters.com/trenes.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="ry-grid2">
            ...
            <div className="ry-video-wrap">
              <div className="ry-video-inner">
                <video src="https://cdn.elimfilters.com/railway.mp4" autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
