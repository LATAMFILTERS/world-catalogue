...
export default function Manufacturing() {
  const css = `
    ...
    .mf-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('${WP}/manufactura.jpg') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="mf-grid2">
            ...
            <div className="mf-video-wrap">
              <div className="mf-video-inner">
                <video src={`${WP}/maquinaria.mp4`} autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
