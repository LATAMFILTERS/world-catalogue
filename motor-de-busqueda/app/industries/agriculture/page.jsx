    ...
    <div className="ag">
      ...
      <section className="ag-hero">
        <div className="ag-hero-inner">
          ...
          <p className="ag-hero-p">Precision filtration engineered for combine harvesters, tractors, sprayers, and heavy-duty agricultural machinery. Crop production operates on narrow seasonal windows where a single mechanical failure during planting or harvest translates directly into yield loss and revenue damage. Our technology shields fuel injection systems, hydraulic circuits, engine lubrication, and air intake from organic dust, pollen, chaff, and field-stored fuel contamination – extending service intervals, protecting high-value powertrain components, and eliminating unplanned downtime across grain, row crop, and specialty operations worldwide. Precision-matched to OEM specifications across 5,000+ cross-references. Certified to ISO 16889 standards.</p>
        </div>
      </section>
