...
export default function Agriculture() {
  const css = `
    ...
    .ag-hero{min-height:80vh;display:flex;align-items:center;background:linear-gradient(to right,rgba(0,0,0,0.9) 30%,rgba(0,0,0,0.2) 100%),url('https://cdn.elimfilters.com/agriculture-2_converted.avif') center/cover no-repeat;padding:120px 6% 80px;border-bottom:1px solid rgba(255,255,255,0.04);}
          ...
          <div className="ag-grid2">
            ...
            <div className="ag-video-wrap">
              <div className="ag-video-inner">
                <video src="https://cdn.elimfilters.com/Agriculture-4.mp4" autoPlay muted loop playsInline />
              </div>
            </div>
          </div>
        </div>
