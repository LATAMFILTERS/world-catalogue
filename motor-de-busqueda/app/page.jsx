...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .f-logo{height:28px;width:auto;max-width:160px;margin-bottom:12px;} .f-tagline{font-family:'Barlow',sans-serif;font-size:11px;color:var(--y);text-transform:uppercase;letter-spacing:.15em;} .f-corp{font-family:'JetBrains Mono',monospace;font-size:9px;color:var(--g4);letter-spacing:.15em;text-transform:uppercase;} .footer-top-bar{display:none;} .footer-brand{display:flex;flex-direction:column;gap:12px;} .f-social{display:flex;gap:10px;} .f-social-link{width:34px;height:34px;border:1px solid var(--g6);display:flex;align-items:center;justify-content:center;font-family:'Russo One',sans-serif;font-size:10px;color:var(--g3);text-decoration:none;text-transform:uppercase;transition:all .2s;} .f-social-link:hover{border-color:var(--y);color:var(--y);}
