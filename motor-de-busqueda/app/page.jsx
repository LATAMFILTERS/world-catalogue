    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .hero-bg{position:absolute;inset:0;background-image:url('');background-size:cover;background-position:center top;}
        ...
        .cta::before{content:'ELIMFILTERS';position:absolute;font-family:'Barlow Condensed',sans-serif;font-size:180px;font-weight:900;color:rgba(0,0,0,.05);right:-10px;top:50%;transform:translateY(-50%);pointer-events:none;white-space:nowrap;}
...
av + (scrollY>50?'sc':'')}>
      ...
      <section className="problem">
        <div className="prob-in">
          <div>
            ...
            <h2 className="s-title">WHAT YOU CANT SEE<br/><span>IS DESTROYING YOUR FLEET</span></h2>
            <div className="prob-list">
              {[{title:'Injector Erosion',desc:'Micronic particles deform spray orifices, causing immediate power loss and poor combustion.'},{title:'Critical Bearing Friction',desc:'Contaminated oil accelerates metal wear, reducing engine block life by up to 40%.'},{title:'Fuel Drainage',desc:'A restricted engine consumes up to 8% more diesel to maintain the same torque levels.'}].map((item,i)=>(
                <div key={i} className="prob-item"><div className="prob-num">0{i+1}</div><div className="prob-text"><h3>{item.title}</h3><p>{item.desc}</p></div></div>
              ))}
            </div>
          </div>
          <div className="prob-img">
            <img src={IMAGES.mechanic} alt="ELIMFILTERS technician"/>
            <div className="prob-img-ov"><div className="dmg-badge">80%</div><div className="dmg-label">Of premature failures are caused by contamination</div></div>
          </div>
        </div>
      </section>
        ...
        <div className="tech-in">
          ...
          <div className="tech-grid">
            {technologies.map((t,i)=>(
              <div key={i} className="tech-card"><img src={t.logo} alt={t.name} className="tech-logo"/><div className="tech-desc">{t.desc}</div><div className="tech-pfx">{t.prefix}</div></div>
            ))}
          </div>
        </div>
      </section>
      <section className="ind-sec">
        <div className="ind-in">
          <div className="ind-preview">
            ...
            <div className="ind-preview-ov"><div className="ind-preview-name">{industries[activeIndustry].name}</div></div>
          </div>
          <div>
      ...
      <section className="cta">
        <div className="cta-in">
          ...
          <div className="cta-btns"><a href="/search" className="btn-p">FIND MY FILTER</a><a href="/dealers" className="btn-s">BECOME A DEALER</a></div>
        </div>
      </section>
      <footer className="footer">
        <div className="footer-in">
          <div className="footer-grid">
            <div><img src={IMAGES.logo} alt="ELIMFILTERS" className="f-logo"/><p className="f-tag">Intelligence and Engineering in Filtration. Asset Protection Systems for Heavy Industry worldwide.</p><img src={IMAGES.seal} alt="Authorized" className="f-seal"/></div>
            <div><div className="f-col-t">Company</div><a href="/about" className="f-link">About Us</a><a href="/industries" className="f-link">Industries</a><a href="/knowledge" className="f-link">Knowledge Hub</a><a href="/contact" className="f-link">Contact</a></div>
