  ...
  try {
    ...
    for (const pair of pairList) {
      try {
        ...
        // 6. Reassign FK references in all child tables before DELETE
        await client.query(
