...
console.log(`[HERMES collect] source_mode=${sourceMode} mode=${summary.mode} sources=${summary.sources_total} enabled=${summary.sources_enabled}`);
console.log(`[HERMES collect] created=${summary.created} previewed=${summary.previewed} unchanged=${summary.unchanged} duplicates=${summary.duplicates} fetch_errors=${summary.fetch_errors} invalid=${summary.invalid} disabled=${summary.disabled}`);
