...
console.log(full
  ? 'Manual pre-merge validation passed, including canonical taxonomy, citation-grade core technologies, canonical URL policy, crawler-visible i18n, frontend type-check and build.'
