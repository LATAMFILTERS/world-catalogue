...
function snapshot(){
  ...
  const crmOutbox = jsonList(path.join(STATE,'crm-bridge','outbox'),100);
  return {
...
http.createServer((req,res)=>{
  ...
  if(req.url==='/api/crm'){res.writeHead(200,{'content-type':'application/json'});return res.end(JSON.stringify(s.crm,null,2));}
