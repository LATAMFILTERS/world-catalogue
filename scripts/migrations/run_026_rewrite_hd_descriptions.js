...
const BODIES = [
  ...
  { prefix: 'EF9', label: 'Fuel — SYNTAPORE™', body: 'Fuel filter for diesel injection systems. SYNTAPORE™ media removes particulate and water contamination before fuel reaches high-pressure injectors, protecting against injector wear and stalling caused by dirty fuel.' },
  { prefix: 'ES9', label: 'Fuel/Water Separator — TURBOCORE™', body: 'Fuel/water separator for diesel fuel systems. TURBOCORE™ media coalesces and drains free water from fuel before it reaches the injection system, preventing injector corrosion and microbial growth in the fuel tank.' },
