...
|---------|------|-------------|
| `/api/citation/index.json` | index.json | All 69 entity records |
| `/api/citation/[KEY].json` | MACROCORE.json etc | Single entity lookup with _links |
| `/api/citation/graph.json` | graph.json | Full edge list (556 edges) |
...
Last generated: 2026-08-29T22:54:25.799Z
