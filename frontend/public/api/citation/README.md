...
|---------|------|-------------|
| `/api/citation/index.json` | index.json | All 68 entity records |
| `/api/citation/[KEY].json` | MACROCORE.json etc | Single entity lookup with _links |
| `/api/citation/graph.json` | graph.json | Full edge list (548 edges) |
...
Last generated: 2026-08-19T03:37:15.215Z
