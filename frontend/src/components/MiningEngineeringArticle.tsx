...
const relatedCard = { background: '#050505', padding: '1.6rem', minHeight: '190px', textDecoration: 'none', color: '#fff', display: 'flex', flexDirection: 'column', minWidth: 0 } as const;
