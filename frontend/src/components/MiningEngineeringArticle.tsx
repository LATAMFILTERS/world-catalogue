...
const relatedGrid = { marginTop: '2rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,.1)', border: '1px solid rgba(255,255,255,.1)' } as const;
const relatedCard = { background: '#050505', padding: '1.6rem', minHeight: '190px', textDecoration: 'none', color: '#fff', display: 'flex', flexDirection: 'column', flex: '1 1 250px', maxWidth: '400px', minWidth: 0 } as const;
