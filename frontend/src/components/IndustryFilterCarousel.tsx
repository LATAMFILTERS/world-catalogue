...
const INDUSTRY_INTRO: Record<string, string> = {
  ...
  'Trucks Fleets': 'Truck fleets depend on consistent service decisions across long-haul, regional and vocational duty. ELIMFILTERS® filtration systems support air intake, fuel, lubrication, cooling, compressed-air, cabin and applicable hydraulic protection while keeping product selection tied to the vehicle, engine, duty profile and validated application evidence. Fleet standardization should follow confirmed compatibility rather than assumed cross-reference equivalence.',
