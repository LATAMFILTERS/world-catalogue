...
const grid3: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)', marginTop: '2rem' };
const grid2: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)', marginTop: '2rem' };
const card: CSSProperties = { background: '#000', padding: '1.6rem', flex: '1 1 245px', minWidth: 0 };
const lineCard: CSSProperties = { background: '#000', padding: '1.6rem 1.8rem', borderLeft: '2px solid rgba(255,241,45,.55)', flex: '1 1 300px', minWidth: 0 };
...
const familyGrid: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)', marginTop: '2rem' };
const familyCard: CSSProperties = { background: '#050505', padding: '1.6rem', textDecoration: 'none', color: '#fff', display: 'block', flex: '1 1 260px', minWidth: 0 };
...
const decisionFlow: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', marginTop: '2rem', background: 'rgba(255,255,255,.08)' };
const decisionStep: CSSProperties = { background: '#050505', padding: '1.2rem', fontFamily: displayFont, fontWeight: 700, fontSize: '.74rem', letterSpacing: '.08em', flex: '1 1 190px', minWidth: 0 };
