...
const grid3: CSSProperties = { maxWidth: '1180px', margin: '2.4rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)' };
const grid2: CSSProperties = { maxWidth: '1180px', margin: '2.4rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.07)' };
const card: CSSProperties = { background: '#000', padding: '1.6rem', flex: '1 1 250px', minWidth: 0 };
const lineCard: CSSProperties = { background: '#000', padding: '1.7rem', flex: '1 1 300px', minWidth: 0 };
...
const familyGrid: CSSProperties = { maxWidth: '1180px', margin: '2.4rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.07)' };
const familyCard: CSSProperties = { background: '#000', padding: '1.6rem', textDecoration: 'none', color: '#fff', display: 'block', flex: '1 1 240px', minWidth: 0 };
...
const decisionFlow: CSSProperties = { maxWidth: '1180px', margin: '2.2rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)' };
const decisionStep: CSSProperties = { background: '#000', padding: '1.25rem', fontFamily: displayFont, fontSize: '.72rem', fontWeight: 700, letterSpacing: '.08em', color: 'rgba(255,255,255,.72)', flex: '1 1 180px', minWidth: 0 };
