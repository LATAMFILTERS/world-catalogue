...
const ITEMS = [
  ...
  { href: '/technologies', en: 'Technology & Innovation', es: 'Tecnología e Innovación' },
  { href: '/legal/ai-policy', en: 'Governance', es: 'Gobernanza' },
];
...
export function AboutSubnav() {
  ...
  return (
    <nav
      ...
      aria-label={isSpanish ? 'Navegación de Acerca de' : 'About navigation'}
      style={{
        position: 'relative',
        zIndex: 5,
        ...
        {ITEMS.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{
              color: active ? '#ffffff' : '#292925',
              background: active ? '#292925' : 'transparent',
