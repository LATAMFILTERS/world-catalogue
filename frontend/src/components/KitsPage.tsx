            ...
            <div className="product-desc-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
              <AnimateIn direction="left">
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                  ...
                  >
                    FILTER KITS — MODEL-SPECIFIC ASSEMBLY
                  </h2>
                </div>
                <h3
                  style={{
                ...
                >
                  Every Filter. One Interval. One Order.
                </h3>
                <p
                  style={{
                    fontSize: '1rem',
                ...
                >
                  ELIMFILTERS<sup style={{fontSize:'0.55em',verticalAlign:'super',letterSpacing:0}}>®</sup> maintenance kits eliminate the single most common cause of premature engine failure in fleets: asynchronous filter changes. When oil, fuel and air filters are replaced at different intervals, contamination windows open between services. Our model-specific bundles synchronize every element to the same change interval — oil filter, fuel primary, fuel secondary, air filter and cabin filter in one ISO-certified package, verified fit for the target OEM platform.
                </p>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <StaggerContainer style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '4rem' }}>
              {[
                ...
                { brand: 'INTERNATIONAL', models: 'LT, RH, HX series — ProStar and medium-duty commercial trucks' },
                ...
                >
                  <h3 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#FFF12D', fontFamily: 'Montserrat, sans-serif', marginBottom: '0.75rem', letterSpacing: '0.05em' }}>
                    {oem.brand}
                  </h3>
