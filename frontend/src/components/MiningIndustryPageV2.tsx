...
const riskGrid: CSSProperties = { maxWidth: '1180px', margin: '3rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.1)', border: '1px solid rgba(255,255,255,.1)' };
const riskCard: CSSProperties = { background: '#050505', padding: '1.8rem', minHeight: '240px', minWidth: 0, flex: '1 1 240px' };
...
const valueGrid: CSSProperties = { maxWidth: '1180px', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.1)', border: '1px solid rgba(255,255,255,.1)' };
const valueCard: CSSProperties = { background: '#050505', padding: '1.5rem', minHeight: '190px', flex: '1 1 300px', minWidth: 0 };
...
const decisionGrid: CSSProperties = { maxWidth: '1180px', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.1)', border: '1px solid rgba(255,255,255,.1)' };
const decisionCard: CSSProperties = { background: '#030303', minHeight: '210px', padding: '1.5rem', flex: '1 1 190px', minWidth: 0 };
