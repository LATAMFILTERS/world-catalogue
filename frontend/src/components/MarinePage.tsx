      ...
      <main style={{ background: '#000', color: '#fff' }}>
        ...
        >
          ...
          >
            ...
            >
              Filtration systems engineered for the harshest environment on earth. Saltwater corrosion, fuel contamination, hydraulic failures and air intake fouling are the leading causes of marine engine loss — ELIMFILTERS<sup style={{fontSize:'0.55em',verticalAlign:'super',letterSpacing:0}}>®</sup> addresses all four simultaneously.
            </motion.p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="product-desc-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
              <AnimateIn direction="left">
                ...
                >
                  Marine engines operate under conditions that expose every filtration weakness simultaneously: saltwater aerosol ingestion, condensation in fuel tanks, biofouling in stored diesel, hydraulic deck machinery under constant shock loads and air intakes exposed to spray and particulate. ELIMFILTERS<sup style={{fontSize:'0.55em',verticalAlign:'super',letterSpacing:0}}>®</sup> marine product line covers all four critical circuits — fuel, lube, hydraulic and air — with elements built for the corrosive, high-humidity, high-vibration demands of offshore, commercial and naval operations.
                </p>
