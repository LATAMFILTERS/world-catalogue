...
const seasonGrid: CSSProperties = { marginTop: '2.8rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,.1)', border: '1px solid rgba(255,255,255,.1)' };
const seasonCard: CSSProperties = { background: '#050505', padding: '1.55rem', minHeight: '210px', flex: '1 1 220px', maxWidth: '350px', minWidth: 0 };
...
const decisionCard: CSSProperties = { background: '#030303', minHeight: '205px', padding: '1.5rem', flex: '1 1 205px', maxWidth: '330px', minWidth: 0 };
