...
const grid2: CSSProperties = { maxWidth: '1180px', margin: '2rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.06)' };
const grid3: CSSProperties = { maxWidth: '1180px', margin: '2rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.06)' };
const grid4: CSSProperties = { maxWidth: '1180px', margin: '2rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.06)' };
const card: CSSProperties = { background: '#000', padding: '1.7rem', minHeight: '190px', flex: '1 1 220px', minWidth: 0 };
const lineCard: CSSProperties = { background: '#000', padding: '1.8rem', flex: '1 1 280px', minWidth: 0 };
...
const decisionFlow: CSSProperties = { maxWidth: '1180px', margin: '2rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.06)' };
const decisionStep: CSSProperties = { background: '#070707', padding: '1.4rem', fontFamily: displayFont, fontWeight: 700, fontSize: '.78rem', lineHeight: 1.45, letterSpacing: '.08em', color: 'rgba(255,255,255,.82)', flex: '1 1 200px', minWidth: 0 };
