          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="product-desc-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
              <AnimateIn direction="left">
                ...
                >
                  ELIMFILTERS<sup style={{fontSize:'0.55em',verticalAlign:'super',letterSpacing:0}}>®</sup> air dryer cartridges combine a two-stage process: a coalescing pre-filter captures oil aerosols and liquid water before they reach the desiccant bed, extending desiccant life and preventing channeling. The activated desiccant matrix then drives moisture content to zero dew point — protecting pneumatic valves, brake chambers, ABS modulators and downstream instrumentation from corrosion, freeze-up and premature failure.
                </p>
