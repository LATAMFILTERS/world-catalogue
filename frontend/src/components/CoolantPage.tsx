      ...
      <main style={{ background: '#000', color: '#fff' }}>
        ...
        <section
          style={{
            ...
            display: 'flex',
            alignItems: 'center',
            backgroundImage: 'url(/images/coolant-hero.avif)',
        ...
        >
          ...
          >
            ...
            >
              Active inhibitor technology with thermal stability and cavitation prevention. Engineered to defend cooling circuits against corrosion, liner pitting and electrolytic degradation across every heavy-duty application.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                  ...
                  >
                    COOLANT FILTERS — ACTIVE INHIBITOR MEDIA
                  </h2>
                </div>
                <h3
                  style={{
                ...
                >
                  Total Cooling Circuit Asset Protection
                </h3>
                <p
                  style={{
                    fontSize: '1rem',
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            >
              <div style={{ border: '1px solid rgba(255,241,45,0.2)', borderRadius: '12px', padding: '2.5rem', background: '#000' }}>
                ...
                <p style={{ fontSize: '0.9rem', fontWeight: 700, letterSpacing: '0.05em', color: 'rgba(255,255,255,0.9)', margin: 0 }}>
                  COOLING SYSTEM LIFESPAN EXTENSION
                </p>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.65)', fontFamily: 'Inter, sans-serif', marginTop: '0.5rem' }}>
                  Sustained inhibitor release delays component wear in cylinder liners, water pumps and heat exchangers
                </p>
              </div>
              ...
              <div style={{ border: '1px solid rgba(255,241,45,0.2)', borderRadius: '12px', padding: '2.5rem', background: '#000' }}>
                ...
                <p style={{ fontSize: '0.9rem', fontWeight: 700, letterSpacing: '0.05em', color: 'rgba(255,255,255,0.9)', margin: 0 }}>
                  CAVITATION PITTING EVENTS
                </p>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.65)', fontFamily: 'Inter, sans-serif', marginTop: '0.5rem' }}>
                  Continuous protective film on liner walls eliminates cavitation erosion damage
                </p>
              </div>
              ...
              <div style={{ border: '1px solid rgba(255,241,45,0.2)', borderRadius: '12px', padding: '2.5rem', background: '#000' }}>
                ...
                <p style={{ fontSize: '0.9rem', fontWeight: 700, letterSpacing: '0.05em', color: 'rgba(255,255,255,0.9)', margin: 0 }}>
                  CROSS-COMPATIBLE FORMULATION
                </p>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.65)', fontFamily: 'Inter, sans-serif', marginTop: '0.5rem' }}>
                  Validated across Caterpillar, Cummins, Detroit, Volvo and all major diesel OEM platforms
                </p>
              </div>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.65)', fontFamily: 'Inter, sans-serif', fontStyle: 'italic', lineHeight: 1.65, maxWidth: '800px', margin: '0 auto' }}>
                Results verified in heavy transport, power generation, mining and construction fleets operating under sustained thermal load.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
              {[
                { title: 'HEAVY TRANSPORT', desc: 'Long-haul trucks and fleet diesel engines. Prevents liner cavitation and coolant acidification during high-load extended service intervals.' },
                { title: 'POWER GENERATION', desc: 'Stationary diesel gensets and co-generation plants. Maintains coolant chemistry stability during continuous 24/7 thermal cycling.' },
                { title: 'MINING', desc: 'Off-highway haul trucks and drilling rigs. Defends cooling systems against contamination from extreme ambient temperatures and dusty environments.' },
                { title: 'CONSTRUCTION', desc: 'Excavators, motor graders and compaction equipment. Sustains engine thermal regulation on high duty-cycle operations.' },
                { title: 'AGRICULTURE', desc: 'Tractors and combine harvesters. Protects cooling circuits during peak seasonal loads and extended field hours.' },
                { title: 'MARINE', desc: 'Diesel propulsion and auxiliary engines. Resists electrolytic corrosion from saltwater intrusion and mixed-metal cooling circuits.' },
              ].map((app, idx) => (
                <div
                  key={idx}
                  style={{
        ...
        <section style={{ padding: '6rem 2rem', background: '#FFF12D', textAlign: 'center' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1rem', color: '#000', marginBottom: '2rem', lineHeight: 1.6, fontFamily: 'Inter, sans-serif' }}>
              Identify your SKU. Cross-reference 500,000+ parts. Find your coolant filtration solution now.
            </p>
            <a
