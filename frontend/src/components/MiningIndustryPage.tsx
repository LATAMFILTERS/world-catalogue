...
const riskGrid: CSSProperties = { maxWidth: '1180px', margin: '3rem auto 0', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)' };
const riskCard: CSSProperties = { background: '#050505', padding: '1.8rem', minHeight: '285px', minWidth: 0, flex: '1 1 240px' };
...
const decisionGrid: CSSProperties = { marginTop: '2.8rem', display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)' };
const decisionCard: CSSProperties = { background: '#030303', minHeight: '230px', padding: '1.5rem', minWidth: 0, flex: '1 1 190px' };
