...
const riskCard: CSSProperties = { background: '#050505', padding: '1.8rem', minHeight: '285px', minWidth: 0 };
...
const decisionCard: CSSProperties = { background: '#030303', minHeight: '230px', padding: '1.5rem', minWidth: 0 };
