...
const TECHNOLOGIES = [
  ...
  },
  {
    ...
    p1: "HYDROCORE removes free and emulsified water from diesel and turbine fuel systems at 99.8% efficiency — protecting precision HPCR injectors operating at 1,800 to 2,500 bar.",
