...
const grid4: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.08)', marginTop: '2.2rem' };
const grid2: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.07)', marginTop: '2rem' };
const card: CSSProperties = { background: '#050505', padding: '1.5rem', flex: '1 1 220px', minWidth: 0 };
const lineCard: CSSProperties = { background: '#000', padding: '1.5rem 1.7rem', flex: '1 1 300px', minWidth: 0 };
...
const decisionFlow: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,.07)', marginTop: '2rem' };
const decisionStep: CSSProperties = { background: '#050505', padding: '1.25rem', fontFamily: displayFont, fontWeight: 700, fontSize: '.78rem', letterSpacing: '.06em', flex: '1 1 190px', minWidth: 0 };
