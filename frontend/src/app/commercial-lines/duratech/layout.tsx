...
const DESC = 'DURATECH™ is the ELIMFILTERS integrated filter-kit program for coordinated maintenance across trucks, fleets, vehicles, machines, and equipment. DURATECH is a specialized commercial solution, not a filtration technology.';
