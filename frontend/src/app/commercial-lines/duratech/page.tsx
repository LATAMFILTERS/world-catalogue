...
const DATA: TechDetailData = {
  ...
  stages: [
    {
      number: '01',
      tag: 'APPLICATION',
      title: 'Identify the protected asset',
      body: 'Kit selection starts with the specific vehicle, truck, machine or equipment application and its maintenance requirements.',
      stat: 'STEP 1',
      statLabel: 'Application identification',
    },
    {
      number: '02',
      tag: 'PROTECTION',
      title: 'Coordinate required filtration components',
      body: 'The kit groups the filtration components required by the approved application so maintenance can be planned at the asset level rather than as isolated filter replacement.',
      stat: 'STEP 2',
      statLabel: 'Component coordination',
    },
    {
      number: '03',
      tag: 'INTERVAL',
      title: 'Apply the approved maintenance interval',
      body: 'The service interval is governed by the approved application. The 15,000 km claim is reserved for applicable On-Road trucks and commercial vehicles and must not be generalized to other duty classes.',
      stat: '15,000 KM',
      statLabel: 'Approved On-Road interval',
    },
    {
      number: '04',
      tag: 'SERVICE',
      title: 'Maintain application and installation discipline',
      body: 'Coverage and protection language remains conditional on the correct application, installation and maintenance requirements defined by ELIMFILTERS.',
      stat: 'GOVERNED',
      statLabel: 'Application conditions apply',
    },
  ],
  ...
  applications: [
    {
      sector: 'On-Road Trucks & Commercial Vehicles',
      detail: 'Approved applications may use the governed 15,000 km integrated protection interval, subject to ELIMFILTERS application, installation and maintenance conditions.',
    },
    {
      sector: 'Machines & Equipment',
      detail: 'DURATECH™ can organize required filtration components into an integrated maintenance kit, with interval and coverage defined by the specific approved application.',
    },
    {
      sector: 'Mixed Fleets',
      detail: 'Kit-based maintenance can simplify service planning across multiple asset types without converting application-specific intervals into universal claims.',
    },
  ],
