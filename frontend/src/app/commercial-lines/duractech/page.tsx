...
const DATA: TechDetailData = {
  ...
  systemParagraphs: [
    'DURACTECH™ is an integrated maintenance and asset-protection kit architecture. The kit is configured around the vehicle, machine or equipment application so the required filtration components are managed as one maintenance decision rather than as unrelated replacement parts.',
    'For approved On-Road truck and commercial-vehicle applications, DURACTECH™ carries a governed 15,000 km protection interval. That interval applies only to approved applications and remains subject to ELIMFILTERS application, installation, maintenance and coverage conditions. It is not a universal durability claim for individual filters or for off-road, marine or industrial equipment.',
  ],
  productImageSrc: '/images/kits-npr.avif',
  productImageCaption: 'DURACTECH™ — integrated maintenance and asset-protection kit architecture.',
  ...
  applications: [
    ...
    { sector: 'Machines & Equipment', detail: 'DURACTECH™ can organize required filtration components into an integrated maintenance kit, with interval and coverage defined by the specific approved application.' },
  ...
  ctaTag: 'DURACTECH™ APPLICATION IDENTIFICATION',
  ctaHeading: 'Identify the approved kit for your asset',
  ctaBody: 'Use the vehicle, machine or equipment application to identify the appropriate DURACTECH™ configuration and its governed maintenance conditions.',
};
