...
export const metadata: Metadata = {
  ...
  description: DESC,
  keywords: ['DURACTECH filter kit', 'integrated filter kit', 'fleet maintenance kit', 'truck filter kit', 'equipment maintenance kit', 'vehicle filter kit', 'coordinated filtration maintenance', 'ELIMFILTERS specialized solution'],
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://elimfilters.com/commercial-lines/duractech/' },
  openGraph: {
    title: 'DURACTECH™ — Integrated Filter Kit Program | ELIMFILTERS®',
    description: DESC,
    url: 'https://elimfilters.com/commercial-lines/duractech/',
    type: 'website',
...
export default function DuractechLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
