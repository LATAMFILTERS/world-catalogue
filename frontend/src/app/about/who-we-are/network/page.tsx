...
const grid: CSSProperties = { display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: '1px', background: 'rgba(255,255,255,.08)', border: '1px solid rgba(255,255,255,.08)', marginTop: '3rem' };
const card: CSSProperties = { background: '#080808', textDecoration: 'none', color: '#fff', display: 'flex', flexDirection: 'column' };
