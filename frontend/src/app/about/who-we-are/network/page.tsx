...
const grid: CSSProperties = { display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,.08)', border: '1px solid rgba(255,255,255,.08)', marginTop: '3rem' };
const card: CSSProperties = { background: '#080808', textDecoration: 'none', color: '#fff', display: 'flex', flexDirection: 'column', flex: '1 1 280px', maxWidth: '450px', minWidth: 0 };
