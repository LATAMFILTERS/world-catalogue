...
const TECHNOLOGIES = [
  ...
  { code: 'HYDRACORE/SERIES™', href: '/technologies/hydracore-series', domain: 'Bulk Fuel | Marine' },
    ...
    <main style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0 2rem 4rem' }}>
        <RetrievalBlock>
          ...
          <p>MACROCORE™ | MICROKAPPA™ | DRYCORE™ | INTEKCORE™ | SYNTEPORE™ | HYDROCORE™ | HYDRACORE/SERIES™ | SYNTRAX™ | NANOFORCE™ | THERMACORE™</p>
