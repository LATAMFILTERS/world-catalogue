...
const heroLead: CSSProperties = { marginTop: '1.5rem', maxWidth: '880px', color: 'rgba(255,255,255,0.82)', fontSize: 'clamp(1rem, 1.6vw, 1.27rem)', lineHeight: 1.75, fontWeight: 600, textAlign: 'justify' };
...
const partnersCardTop: CSSProperties = { display: 'grid', gridTemplateColumns: '55px minmax(0, 1fr)', gap: '1rem', alignItems: 'start', marginBottom: '0.85rem' };
...
const partnersBody: CSSProperties = { color: 'rgba(255,255,255,0.64)', fontSize: '1rem', lineHeight: 1.76, margin: 0, textAlign: 'justify' };
...
const bodyText: CSSProperties = { color: 'rgba(255,255,255,0.68)', fontSize: '1rem', lineHeight: 1.76, margin: '0 0 1rem', textAlign: 'justify' };
