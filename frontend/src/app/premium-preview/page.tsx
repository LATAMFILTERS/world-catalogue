...
function Technology() {
  ...
  const techs = [
    { id:'NANOFORCE™',        img:'/assets/nanoforce.avif',        tag:'Hydraulic Precision Guard',          color: G,                        beta:'3 Layers',       micron:'3 µm',   collapse:'High-PSI', temp:'+85°C',  std:'ISO 16889',  bar:100, apps:['Hydraulics','Mining','Construction'],         desc:'Multi-layer protection with vapor control barrier. Engineered for high-pressure hydraulic circuits with continuous pulsation cycles. Dissolved vapor captured before phase transition.' },
    { id:'MACROCORE™',        img:'/assets/macrocore.avif',        tag:'Progressive Density Gradient Air',   color:'rgba(99,179,237,0.9)',     beta:'99.98%',         micron:'PDG',    collapse:'62 PSI',  temp:'+120°C', std:'ISO 5011',   bar:92,  apps:['Air Intake','Mining','Agriculture'],           desc:'Three-zone Progressive Density Gradient distributes contamination load across full media depth. 62 PSI anti-collapse rated. Equidistant pleat geometry prevents blind pleats.' },
    { id:'SYNTEPORE™',        img:'/assets/syntepore.avif',        tag:'Precision Injector Guard',           color:'rgba(192,132,252,0.9)',    beta:'Zero Migration', micron:'4 µm',   collapse:'Rated',   temp:'+90°C',  std:'ISO 16332',  bar:86,  apps:['HPCR Fuel','Injectors','Agriculture'],         desc:'Terminal protection for Common Rail injection systems operating above 2,000 bar. Zero migration barrier: no particle above 4 µm exits the element under any flow condition.' },
    { id:'AQUAGUARD™',        img:'/assets/aquaguard.avif',        tag:'Hydrophobic Water Separator',        color:'rgba(56,189,248,0.9)',     beta:'99.8% WS',       micron:'2 µm',   collapse:'Rated',   temp:'+80°C',  std:'ISO 16332',  bar:90,  apps:['Marine','Fuel Storage','Offshore'],            desc:'Hydrophobic barrier repels water at molecular level — fuel molecules pass, water cannot. 99.8% separation across free, emulsified and dissolved water phases.' },
    { id:'AQUAGUARD/SERIES™', img:'/assets/aquaguardseries.avif',  tag:'Three-Stage Fuel Asset Protection',  color:'rgba(125,211,252,0.9)',    beta:'99% WS',         micron:'3-stage', collapse:'Rated', temp:'+80°C',  std:'ISO 16332',  bar:88,  apps:['Heavy Transport','Power Gen','Offshore'],      desc:'Sequential three-stage defense: turbine inertial interception → graduated coalescence → AQUAGUARD™ precision barrier. 900FH and 1000FH models for light to heavy duty.' },
    { id:'SYNTRAX™',          img:'/assets/syntrax.avif',          tag:'AI-Calibrated Lube Protection',      color:'rgba(251,146,60,0.9)',     beta:'4 Layers',       micron:'3 µm',   collapse:'≥ 20 bar',temp:'+140°C', std:'ISO 4548-12',bar:82,  apps:['Turbo Engines','Fleet','Mining'],              desc:'Four-layer AI-calibrated density gradient — macro, intermediate, turbo custody barrier and thermal bonding anchor. Layer position locked at manufacture, zero gap formation.' },
    { id:'INTEKCORE™',        img:'/assets/intekcore.avif',        tag:'Heavy-Duty Filter Housing Systems',  color:'rgba(251,191,36,0.9)',     beta:'OEM-Fit',        micron:'Housing',collapse:'High-PSI',temp:'Full range',std:'OEM Spec', bar:91,  apps:['Heavy Trucks','Construction','Mining'],        desc:'High-pressure rated housing systems with precision seal architecture for heavy-duty truck and machinery. Corrosion-resistant construction. Direct OEM replacement — no adapters.' },
    { id:'COOLTECH™',         img:'/assets/cooltech.avif',         tag:'SCA Additive Release Technology',    color:'rgba(239,68,68,0.9)',      beta:'Gradual Release', micron:'SCA',   collapse:'N/A',     temp:'Full range',std:'ASTM D6922',bar:88,  apps:['Diesel Engines','Power Gen','Agriculture'],    desc:'Controlled gradual SCA release maintains coolant chemistry within protection corridor across full service interval. Vapor prevention layer eliminates cylinder liner cavitation erosion.' },
    { id:'DRYCORE™',          img:'/assets/drycore.avif',          tag:'Molecular Sieve Desiccant Dryer',    color:'rgba(74,222,128,0.9)',     beta:'Molecular Sieve',micron:'Vapor',  collapse:'N/A',     temp:'−40°C',  std:'SAE J1750',  bar:78,  apps:['Air Brakes','Pneumatics','Rail'],               desc:'Molecular sieve desiccant captures water vapor before phase transition. Zero moisture breakthrough at rated conditions. Cold-rated to −40°C. Cyclic adsorption/purge compatible.' },
    { id:'MICROKAPPA™',       img:'/assets/microkappa.avif',       tag:'Electrostatic HEPA Cabin Air',       color:'rgba(244,114,182,0.9)',    beta:'99.97%',         micron:'0.3 µm', collapse:'N/A',     temp:'Cabin',  std:'EN 1822',    bar:98,  apps:['Heavy Trucks','Bus & Coach','Agriculture'],    desc:'Three-mechanism cabin protection: electrostatic attraction for PM2.5, activated carbon for NOx/VOC, HEPA-class mechanical barrier for pollen and bacteria. 99.97% at 0.3 µm.' },
  ];
