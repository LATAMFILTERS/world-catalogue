...
function Technology() {
  ...
  const techs = [
    ...
    { id:'HYDROCORE',   img:'/assets/hydrocoreseries.avif',  tag:'Multi-Stage Coalescing Media',        color:'rgba(56,189,248,0.9)',     beta:'WR ≥ 99.5%',     micron:'3 µm',   collapse:'200 kPa', temp:'+80°C',  std:'ISO 19438',  bar:88,  apps:['Marine','Offshore','Fuel Storage'],             desc:'Multi-stage coalescing separates free and emulsified water from diesel, biodiesel and HVO fuel streams. Mandatory for offshore applications.' },
...
function ProductLines() {
  ...
  const lines = [
    ...
    { code:'WS', name:'Water Separation',           spec:'ISO 19438 · WR ≥ 99%', desc:'HYDROCORE coalescing elements for free and emulsified water removal from diesel, biodiesel and HVO fuel streams. Mandatory for offshore applications.', ind:'Marine · Offshore · Fuel Storage · Oil & Gas' },
...
function Standards() {
  ...
  const specs = [
    { label:'Media Technology', value:'4 proprietary platforms', sub:'SYNTRAX · NANOFORCE · HYDROCORE · PULSECORE' },
