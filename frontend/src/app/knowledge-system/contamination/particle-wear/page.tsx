...
export default function ParticleWearPage() {
  const sections = [
    ...
    },
    {
      ...
      content: 'ELIMFILTERS filtration technologies reduce particle ingestion and circulation at each entry point: MACROCORE™ Progressive Density Gradient air intake filtration achieves 99.9%–99.98% interception efficiency (ISO 5011), with the outer media zone designed for high-volume dust loading and the downstream barrier optimized against fine particle penetration — stopping abrasive dust before it enters the combustion chamber; SYNTRAX™ multi-layer engine lubrication filtration intercepts sub-micron contamination circulating in the oil before it reaches turbocharger bearings, crankshaft journals and valve train surfaces, maintaining oil cleanliness through the full drain interval; NANOFORCE™ multi-layer hydraulic filtration removes the particle population that drives valve and pump wear in high-pressure hydraulic circuits (200–450 bar). Addressed together as a system — air ingress, lube circulation and hydraulic circulation — these technologies control the particle populations responsible for abrasive wear across the equipment&apos;s critical fluid circuits.'
    }
  ];
  ...
  return (
    <main style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'TechArticle',
        '@id': 'https://elimfilters.com/knowledge-system/contamination/particle-wear',
