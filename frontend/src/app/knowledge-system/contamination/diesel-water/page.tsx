...
export default function DieselWaterContaminationPage() {
  const sections = [
    ...
    {
      title: 'System Damage',
      content: 'Water contamination triggers cascading failure mechanisms: (1) Fuel injector needle stiction — water forms a microfilm on precision needle/seat interfaces, increasing friction coefficient and preventing full closure, causing spray pattern distortion and partial combustion; (2) Corrosion of fuel delivery components — ferrous fuel tank liners, steel fuel lines, and aluminum fuel pumps corrode when water and dissolved oxygen create electrolytic cells, generating rust particulates that embed in fuel and accelerate filter plugging; (3) Microbial colony growth — bacteria (Pseudomonas aeruginosa, Bacillus) and fungi (Cladosporium, Aspergillus) proliferate at fuel-water interfaces, generating biofilm that coats tank interior surfaces and clogs fuel filters within weeks; (4) Fuel gum formation — water catalyzes oxidative degradation of fuel hydrocarbons, producing sticky polymers that deposit on injector tips and combustion chamber walls; (5) Lubricity loss — water dilutes the fuel's inherent lubricity and inactivates synthetic lubricity additives, causing accelerated wear in fuel pumps and injectors.'
    },
    {
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
            <Link href="/knowledge-system/contamination/particle-wear" style={{ textDecoration: 'none' }}>
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.9rem', color: 'rgba(255,255,255,0.7)', margin: 0, lineHeight: 1.5 }}>Abrasive contamination and three-body wear</p>
              </div>
            </Link>
            <Link href="/knowledge-system/contamination/hydraulic-system" style={{ textDecoration: 'none' }}>
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.9rem', color: 'rgba(255,255,255,0.7)', margin: 0, lineHeight: 1.5 }}>Pressurized fluid system contamination</p>
              </div>
            </Link>
          </div>
        </motion.div>
