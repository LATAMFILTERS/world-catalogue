...
export const metadata: Metadata = {
  ...
  description: 'ISO 4406 three-number cleanliness code: particle count targets per system, measurement methods, and correlation to equipment component sensitivity.',
  alternates: {
