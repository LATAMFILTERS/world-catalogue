...
import { JSONLD_KNOWLEDGE_SYSTEM_HUB } from '@/lib/jsonld-constants.generated';

// JSON-LD: DataCatalog — auto-generated from CITATION_INDEX.json via sync-jsonld-constants.js
const PAGE_JSONLD = JSONLD_KNOWLEDGE_SYSTEM_HUB;
