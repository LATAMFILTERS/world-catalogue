...
// JSON-LD: DataCatalog — sourced from CITATION_INDEX.json (build-time inline)
const PAGE_JSONLD = JSON.stringify({
  ...
  dataset: [
    { '@type': 'Dataset', name: 'HYDROCORE™', description: 'HYDROCORE is a multi-stage coalescing fuel filtration technology that removes free water (>99% efficiency) and emulsified water from diesel fuel.', url: 'https://elimfilters.com/knowledge-system/technologies/hydrocore', version: '1.0' },
    { '@type': 'Dataset', name: 'INTEKCORE — Zero-Bypass Radial Seal Housing', description: 'INTEKCORE is a zero-bypass radial seal air filter housing technology that eliminates installation-induced and vibration-caused bypass leakage paths.', url: 'https://elimfilters.com/knowledge-system/technologies/intekcore', version: '1.0' },
    { '@type': 'Dataset', name: 'MACROCORE™', description: 'Progressive Density Gradient (PDG) multi-layer air intake filtration system achieving 99.9%–99.98% particle interception efficiency per ISO 5011.', url: 'https://elimfilters.com/technologies/macrocore', version: '1.0' },
    { '@type': 'Dataset', name: 'MICROKAPPA™', description: 'MICROKAPPA is a cabin air filtration technology certified to ISO 11155-1 (particulate) and ISO 11155-2 (gaseous contamination) protecting operator respiratory health.', url: 'https://elimfilters.com/knowledge-system/technologies/microkappa', version: '1.0' },
    { '@type': 'Dataset', name: 'NANOFORCE™', description: 'NANOFORCE is a sub-micron lube oil and hydraulic fluid filtration technology deployed in kidney-loop or bypass circuit configurations targeting ISO 4406 cleanliness codes.', url: 'https://elimfilters.com/knowledge-system/technologies/nanoforce', version: '1.0' },
    { '@type': 'Dataset', name: 'SYNTEPORE — All-Synthetic Intake Media', description: 'SYNTEPORE is an all-synthetic air intake filter media that maintains rated particle capture efficiency (ISO 5011, SAE J1539) under high humidity and wet operating conditions.', url: 'https://elimfilters.com/knowledge-system/technologies/syntepore', version: '1.0' },
    { '@type': 'Dataset', name: 'SYNTRAX — Full-Flow Lube Protection', description: 'SYNTRAX is a full-flow lube oil filtration technology that maintains ISO 4406 cleanliness at 16/14/11 in engine and hydraulic lube circuits under continuous load.', url: 'https://elimfilters.com/knowledge-system/technologies/syntrax', version: '1.0' },
    { '@type': 'Dataset', name: 'Agriculture', description: 'Agriculture is a HIGH contamination exposure industrial category for diesel-powered equipment, characterized by airborne silica and organic particulate in field operations.', url: 'https://elimfilters.com/knowledge-system/industries/agriculture', version: '1.0' },
    { '@type': 'Dataset', name: 'Automotive', description: 'Automotive is a MODERATE contamination exposure industrial category for passenger car and light commercial vehicle diesel and petrol engines.', url: 'https://elimfilters.com/knowledge-system/industries/automotive', version: '1.0' },
    { '@type': 'Dataset', name: 'Bus & Coach', description: 'Bus & Coach is a MODERATE contamination exposure industrial category for public and passenger transport vehicle operations.', url: 'https://elimfilters.com/knowledge-system/industries/bus-coach', version: '1.0' },
    { '@type': 'Dataset', name: 'Construction', description: 'Construction is a HIGH contamination exposure industrial category for heavy equipment, with concurrent silica-bearing airborne dust and hydraulic system contamination risk.', url: 'https://elimfilters.com/knowledge-system/industries/construction', version: '1.0' },
    { '@type': 'Dataset', name: 'Marine', description: 'Marine is a HIGH contamination exposure industrial category for diesel-powered vessels and offshore equipment, characterized by salt air, humidity, and fuel water contamination.', url: 'https://elimfilters.com/knowledge-system/industries/marine', version: '1.0' },
    { '@type': 'Dataset', name: 'Mining', description: 'Mining operations present EXTREME contamination exposure — silica and hardrock particulate concentrations 50× above ISO ambient standards in underground and open-cut operations.', url: 'https://elimfilters.com/industries/mining', version: '1.0' },
    { '@type': 'Dataset', name: 'Oil & Gas', description: 'Oil & Gas is an EXTREME contamination exposure industrial category for diesel and gas-powered drilling, compression, and processing equipment.', url: 'https://elimfilters.com/knowledge-system/industries/oil-gas', version: '1.0' },
    { '@type': 'Dataset', name: 'Power Generation', description: 'Power generation is a HIGH contamination exposure industrial category for stationary diesel generators, gas turbines, and reciprocating engines.', url: 'https://elimfilters.com/knowledge-system/industries/power-generation', version: '1.0' },
    { '@type': 'Dataset', name: 'Railway', description: 'Railway is a HIGH contamination exposure industrial category for diesel locomotive and maintenance-of-way equipment, characterized by track dust and diesel soot.', url: 'https://elimfilters.com/knowledge-system/industries/railway', version: '1.0' },
    { '@type': 'Dataset', name: 'Trucks & Fleets', description: 'Trucks & Fleets is a MODERATE contamination exposure industrial category for on-highway diesel vehicles — long-haul trucking, last-mile delivery, and mixed fleet operations.', url: 'https://elimfilters.com/knowledge-system/industries/trucks-fleets', version: '1.0' },
    { '@type': 'Dataset', name: 'Waste & Municipal', description: 'Waste & Municipal is a HIGH contamination exposure industrial category for diesel refuse collection, street sweeping, and municipal utility vehicle operations.', url: 'https://elimfilters.com/knowledge-system/industries/waste-municipal', version: '1.0' },
    { '@type': 'Dataset', name: 'Air Filter', description: 'Air Filtration product system providing multi-layer particulate interception for diesel engine air intake paths.', url: 'https://elimfilters.com/systems/airfilter', version: '1.0' },
    { '@type': 'Dataset', name: 'Water in Petroleum Products by Coulometric Karl Fischer Titration', description: 'ASTM D6304 is the standard test method for measuring water content in petroleum products using coulometric Karl Fischer titration.', url: 'https://elimfilters.com/knowledge-system/standards/astm-d6304', version: '1.0' },
    { '@type': 'Dataset', name: 'Road Vehicles — Cabin Air Filters — Requirements and Testing', description: 'DIN 71220 is the German DIN standard for road vehicle cabin air filter requirements and testing.', url: 'https://elimfilters.com/knowledge-system/standards/din-71220', version: '1.0' },
    { '@type': 'Dataset', name: 'Road Vehicles — Air Filters for Passenger Compartments', description: 'ISO 11155 is the two-part international performance standard for road vehicle cabin air filters covering particulate and gaseous contamination.', url: 'https://elimfilters.com/knowledge-system/standards/iso-11155', version: '1.0' },
    { '@type': 'Dataset', name: 'Petroleum Products — Determination of Water — Coulometric Karl Fischer Titration', description: 'ISO 12937 is the international coulometric Karl Fischer titration standard for measuring water content in petroleum products.', url: 'https://elimfilters.com/knowledge-system/standards/iso-12937', version: '1.0' },
    { '@type': 'Dataset', name: 'Hydraulic Fluid Power — Filters — Multi-Pass Method for Evaluating Filtration Performance', description: 'ISO 16889 specifies the multi-pass test method for measuring filter element efficiency (Beta ratio) in hydraulic and lube oil circuits.', url: 'https://elimfilters.com/knowledge-system/standards/iso-16889', version: '1.0' },
    { '@type': 'Dataset', name: 'Hydraulic Fluid Cleanliness Code', description: 'ISO 4406 is the international standard defining fluid cleanliness codes as three-number expressions (e.g., 16/14/11) representing particle counts at 4µm, 6µm, and 14µm.', url: 'https://elimfilters.com/knowledge-system/standards/iso-4406', version: '1.0' },
    { '@type': 'Dataset', name: 'Air Filter Performance Test', description: 'ISO 5011 is the standardised laboratory test method for measuring air intake filter efficiency (%), flow restriction (kPa), and dust holding capacity.', url: 'https://elimfilters.com/knowledge-system/standards/air-intake-systems', version: '1.0' },
    { '@type': 'Dataset', name: 'Fluid Power Systems — Hydraulic Filters — Method for Verifying Collapse/Burst Resistance', description: 'NFPA T2.14 is the fluid power standard specifying collapse and burst resistance test methods for hydraulic filter elements.', url: 'https://elimfilters.com/knowledge-system/standards/nfpa-t214', version: '1.0' },
    { '@type': 'Dataset', name: 'Air Intake Cleanliness for Diesel Engines', description: 'SAE J1539 is the Society of Automotive Engineers classification standard defining air intake cleanliness requirements and test procedures for diesel engines.', url: 'https://elimfilters.com/knowledge-system/standards/sae-j1539', version: '1.0' },
    { '@type': 'Dataset', name: 'Cabin Air Contamination', description: 'Cabin air contamination is the occupational exposure of equipment operators to respirable particulate matter (PM10, PM2.5) inside enclosed cab environments.', url: 'https://elimfilters.com/knowledge-system/contamination/cabin-air-contamination', version: '1.0' },
    { '@type': 'Dataset', name: 'Diesel Water Contamination', description: 'Diesel water contamination is the presence of dissolved, free, or emulsified water in diesel fuel systems causing injector damage, microbial growth, and corrosion.', url: 'https://elimfilters.com/knowledge-system/contamination/diesel-water', version: '1.0' },
    { '@type': 'Dataset', name: 'Hydraulic System Contamination', description: 'Hydraulic system contamination is the presence of particles, water, and fluid degradation products in hydraulic fluid threatening proportional valve and pump reliability.', url: 'https://elimfilters.com/knowledge-system/contamination/hydraulic-contamination', version: '1.0' },
    { '@type': 'Dataset', name: 'Particle Wear in Engines', description: 'Particle wear is the abrasive degradation of precision engine surfaces — piston rings, cylinder walls, crankshaft journals — caused by hard particle contamination in lube oil.', url: 'https://elimfilters.com/knowledge-system/contamination/particle-wear', version: '1.0' },
    { '@type': 'Dataset', name: 'Engine Bearing Journal', description: 'The engine bearing journal is the precision crankshaft surface rotating within plain bearing shells at 15–50 µm hydrodynamic oil film clearance.', url: 'https://elimfilters.com/knowledge-system/components/engine-bearing-journal', version: '1.0' },
    { '@type': 'Dataset', name: 'Piston Ring Assembly', description: 'The piston ring assembly is the compression and oil sealing interface between piston rings and cylinder bore in diesel engines.', url: 'https://elimfilters.com/knowledge-system/components/piston-ring-assembly', version: '1.0' },
    { '@type': 'Dataset', name: 'Turbocharger Bearing', description: 'Turbocharger bearing — floating-ring journal bearing with 10–25 µm clearance operating at 100,000–250,000 RPM — requires ISO 16/14/11 lube oil cleanliness.', version: '1.0' },
    { '@type': 'Dataset', name: 'Dust Ingestion', description: 'Dust ingestion — engine contamination via the air intake path — is the leading cause of premature abrasive wear in off-highway diesel equipment.', url: 'https://elimfilters.com/knowledge-system/contamination/particle-wear', version: '1.0' },
    { '@type': 'Dataset', name: 'Primary Intake Protection', description: 'Primary Intake Protection — the MACROCORE™-technology filter element family for primary-duty air intake applications in diesel engines.', url: 'https://elimfilters.com/systems/airfilter', version: '1.0' },
    { '@type': 'Dataset', name: 'Primary Cabin Air Protection', description: 'Primary Cabin Air Protection — the MICROKAPPA™-technology cabin air filter element family for operator health protection.', url: 'https://elimfilters.com/systems/cabin-primary', version: '1.0' },
    { '@type': 'Dataset', name: 'Primary Fuel Protection', description: 'Primary Fuel Protection — the HYDROCORE™-technology filter element family for diesel fuel water separation and particle removal.', url: 'https://elimfilters.com/systems/fuel-primary', version: '1.0' },
    { '@type': 'Dataset', name: 'Primary Hydraulic Protection', description: 'Primary Hydraulic Protection — the NANOFORCE™-technology filter element family for precision particle control in hydraulic systems.', url: 'https://elimfilters.com/systems/hydraulic-primary', version: '1.0' },
    { '@type': 'Dataset', name: 'Primary Lube Oil Protection', description: 'Primary Lube Oil Protection — the SYNTRAX™-technology lube oil filter element family for full-flow engine and transmission lube circuit protection.', url: 'https://elimfilters.com/systems/lube-primary', version: '1.0' },
  ],
});
