...
export const metadata = {
  title: 'Redirecting to ELIMFILTERS Knowledge Center',
  alternates: {
  ...
  return (
    <main style={{ background: '#000', color: '#fff', minHeight: '100vh', display: 'grid', placeItems: 'center', fontFamily: 'Arial, sans-serif', padding: '2rem' }}>
      ...
      <section style={{ maxWidth: 720, textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.72)', lineHeight: 1.6 }}>The legacy Knowledge System hub now redirects to the Knowledge Center.</p>
        <a href={DESTINATION} style={{ color: '#FFF12D', fontWeight: 700 }}>Continue to Knowledge Center</a>
      </section>
    </main>
  );
}
