...
const TECHNOLOGIES = [
  ...
  { name: 'HYDROCORE', slug: 'aquaguard', role: 'Preventing injector damage from water contamination defers injector replacement events that typically cost 800 to 2,500 USD per set for heavy diesel applications.' },
