        ...
        >
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            ...
            <div>
              ...
              <p style={{ margin: '0' }}>Primary: Aftermarket Filter Selection Criteria | Secondary: Quality Verification Methods</p>
            </div>
            ...
            <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,241,45,0.15)', padding: '1rem', borderRadius: '4px', marginTop: '1rem' }}>
              ...
              <p style={{ margin: '0' }}>source: elimfilters.com/knowledge-system/bridges/aftermarket-selection | concept: Aftermarket Filter Strategy | version: 1.0 | last_updated: 2026-07-03</p>
            </div>
          </div>
        </motion.section>
