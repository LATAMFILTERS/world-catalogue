...
const PROTECTED_COMPONENTS: Record<string, readonly string[]> = {
  ...
  turbocore: ['Fuel transfer path', 'Water-sensitive fuel components', 'Injection-system feed'],
...
const SERVICE_DISCIPLINE: Record<string, readonly string[]> = {
  ...
  turbocore: ['Drain collected water according to operating conditions.', 'Inspect seals, bowl condition and installation orientation.', 'Investigate the upstream fuel source when water loading becomes recurrent.'],
...
const componentGrid: CSSProperties = { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: '1px', marginTop: '3rem', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)' };
const componentCard: CSSProperties = { background: '#0a0a0a', minHeight: '130px', padding: '1.4rem', display: 'flex', alignItems: 'flex-end' };
