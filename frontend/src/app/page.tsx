      ...
      <main>
        ...
        <section
          style={{
            background: '#000',
            backgroundImage:
              'linear-gradient(to right, rgba(0,0,0,0.9) 20%, rgba(0,0,0,0.1) 70%), url(https://elimfilters.com/wp-content/uploads/2026/02/Gemini_Generated_Image_8slfcz8slfcz8slf.png)',
            backgroundSize: 'cover',
          ...
          >
            <div style={{ maxWidth: '560px' }}>
              ...
              >
                TECHNOLOGY THAT
                <br />
                <span style={{ color: '#FFF12D' }}>EXCEEDS THE STANDARD.</span>
              </h2>
              <p
                style={{
                  color: 'rgba(255,255,255,0.75)',
              ...
              >
                From high-density synthetic media to hydrophobic separation systems designed for
                extreme conditions.
              </p>
              <a
                href="/technologies"
