        ...
        <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
          <div style={{
            ...
            <div style={{
              ...
              <img src="/images/oilfilter-mecan.avif" alt="Lubrication Filter" style={{ position: 'absolute' as const, inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', filter: 'brightness(0.75) contrast(1.1) saturate(0.8)' }} />
            </div>
          </div>
        </div>
        ...
        <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
          <div style={{
            ...
            <div style={{
              ...
              <img src="/images/Thermacore.avif" alt="Cooling System Filter" style={{ position: 'absolute' as const, inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', filter: 'brightness(0.75) contrast(1.1) saturate(0.8)' }} />
            </div>
          </div>
        </div>
