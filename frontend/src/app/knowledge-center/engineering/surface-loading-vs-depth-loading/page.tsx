...
const relatedGrid = { marginTop:'2rem',display:'flex',flexWrap:'wrap' as const,gap:'1px',background:'rgba(255,255,255,.1)',border:'1px solid rgba(255,255,255,.1)' } as const;
const card = { background:'#050505',padding:'1.6rem',minHeight:'170px',textDecoration:'none',color:'#fff',display:'flex',flexDirection:'column' as const,flex:'1 1 250px',minWidth:0 };
