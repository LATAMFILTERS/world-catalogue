...
const mechanismGrid = { display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)', marginTop: '2.5rem' } as const;
const mechanismCard = { background: '#050505', padding: '1.8rem', minHeight: '270px', flex: '1 1 230px', maxWidth: '370px', minWidth: 0 } as const;
...
const relatedGrid = { marginTop: '2rem', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)' } as const;
const relatedCard = { background: '#050505', color: '#fff', textDecoration: 'none', padding: '1.6rem', minHeight: '190px', display: 'flex', flexDirection: 'column', flex: '1 1 250px', maxWidth: '400px', minWidth: 0 } as const;
