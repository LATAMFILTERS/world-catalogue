  ...
  return (
    <main style={{ background: '#000', color: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        backgroundImage: "linear-gradient(90deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.78) 48%, rgba(0,0,0,0.48) 100%), url('/images/elimfilters_back2.jpg')",
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            ELIMFILTERS Technology Registry
          </motion.h1>
        ...
        {KC_TECHNOLOGIES.map((tech, i) => (
          ...
          >
            <Link href={`/knowledge-center/technologies/${tech.slug}`} style={{ textDecoration: 'none' }}>
              <motion.div
                whileHover={{ background: 'rgba(255,241,45,0.035)', borderLeftColor: '#FFF12D' }}
                style={{
                  background: '#000',
                  padding: '2rem',
                ...
                {tech.performanceSpecs.length > 0 && (
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <p style={{
                      ...
                      {tech.performanceSpecs[0].value}
                      <span style={{ fontWeight: 400, color: 'rgba(255,255,255,0.4)', marginLeft: '0.4rem' }}>
                        {tech.performanceSpecs[0].label}
                      </span>
                    </p>
                  </div>
                )}
