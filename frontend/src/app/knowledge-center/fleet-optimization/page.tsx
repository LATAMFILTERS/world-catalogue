  ...
  const pages = [
    {
      ...
      href: '/fleet-optimization/asset-protection-system',
      icon: '🛡️',
    },
    {
      ...
      href: '/fleet-optimization/total-cost-ownership',
      icon: '💰',
    },
    {
      ...
      href: '/fleet-optimization/contamination-control-strategy',
      icon: '⚙️',
    },
    {
      ...
      href: '/fleet-optimization/equipment-lifecycle-optimization',
      icon: '📈',
    },
    {
      ...
      href: '/fleet-optimization/maintenance-scheduling',
      icon: '📊',
    },
    {
      ...
      href: '/fleet-optimization/predictive-monitoring',
      icon: '🔍',
    },
    {
      ...
      href: '/fleet-optimization/regional-fleet-strategies',
      icon: '🌍',
    },
  ];
