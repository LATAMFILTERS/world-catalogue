...
export const TECH_PAGES: Record<string, TechDetailData> = {
  ...
  intekcore: {
    ...
    stagesHeading: 'SIX ENGINEERING PRINCIPLES FOR HOUSING RELIABILITY.',
    stages: [
      {
        number: '01',
        tag: 'PRINCIPLE 1',
  ...
  SYNTAPORE: {
    categoryTag: '// FUEL ASSET PROTECTION  -  SYNTAPORE™',
    heroTitle: 'SYNTAPORE™',
    ...
    systemParagraphs: [
      ...
      'SYNTAPORE™ is engineered as the terminal protection layer between the fuel supply system and the injection circuit. Where pre-filters handle bulk contamination, SYNTAPORE™ eliminates the residual sub-micron fraction  -  the particles that conventional filtration misses and that HPCR systems cannot tolerate.',
    ...
    productImageCaption: 'SYNTAPORE™  -  PRECISION INJECTOR GUARD ELEMENT',
    ...
    stages: [
      ...
      },
      {
        ...
        body: 'The innermost layer is the SYNTAPORE™ zero migration barrier  -  a high-compaction protection surface designed to achieve absolute retention of any particle that reaches it from layers 1 and 2. Zero migration means no particle above 4 microns exits the element and enters the injection rail under any operating pressure or flow condition. The barrier is structurally reinforced to withstand cold-start fuel viscosity spikes without bypass.',
        stat: '0',
    ...
    applicationsHeading: 'WHERE SYNTAPORE™ PROTECTS',
    applicationsSubtext: 'SYNTAPORE™ is the designated precision protection element for any diesel system where fuel injection tolerances demand sub-4-micron cleanliness.',
    applications: [
    ...
    testimonial: {
      quote: 'Our HPCR injection system was generating one injector failure per 60,000 kilometers on average. With SYNTAPORE™ inline protection, we passed 180,000 kilometers on the test fleet with zero injection events. The sub-micron barrier is the difference.',
      role: 'Technical Director',
      sector: 'Commercial Fleet  -  Long-Haul Division',
    },
    ctaTag: 'IDENTIFY YOUR SYNTAPORE™ ELEMENT',
    ctaHeading: 'FIND YOUR INJECTOR PROTECTION',
    ctaBody: 'Cross-reference 500,000+ OEM part numbers. Identify the exact SYNTAPORE™ element for your fuel injection system specification.',
  },

  TURBOCORE: {
    categoryTag: '// WATER SEPARATION TECHNOLOGY  -  TURBOCORE™',
    heroTitle: 'TURBOCORE™',
    ...
    heroImage: '/images/TURBOCORE-hero.avif',
    heroStats: [
    ...
    productImageCaption: 'TURBOCORE™  -  WATER SEPARATION PROTECTION TECHNOLOGY',
    ...
    stages: [
      ...
      },
      {
        number: '03',
        tag: 'PHASE 3',
        title: 'TURBOCORE™ HYDROPHOBIC BARRIER',
    ...
    applicationsSubtext: 'TURBOCORE™ water separation technology protects any fuel system where water ingress threatens injection system integrity.',
    applications: [
    ...
    testimonial: {
      quote: 'Water intrusion was destroying our injection pumps on a predictable seasonal cycle. TURBOCORE™ hydrophobic separation eliminated that cycle entirely  -  our last two maintenance inspections showed dry sumps across every test unit.',
      role: 'Agricultural Equipment Director',
      sector: 'Harvest Operations  -  45 combine harvesters',
    },
    ctaTag: 'IDENTIFY YOUR TURBOCORE™ ELEMENT',
    ctaHeading: 'FIND YOUR WATER PROTECTION',
    ctaBody: 'Cross-reference 500,000+ OEM part numbers. Identify the exact TURBOCORE™ water separation element for your fuel system.',
  },
