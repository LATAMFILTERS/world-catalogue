...
const decisionFlow: CSSProperties = { maxWidth: '1180px', margin: '2rem auto 0', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1px', background: 'rgba(255,255,255,0.08)' };
const decisionStep: CSSProperties = { background: '#000', padding: '1.2rem', fontFamily: displayFont, fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.08em', color: '#fff', flex: '1 1 190px', maxWidth: '300px', minWidth: 0 };
