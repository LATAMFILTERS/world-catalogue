...
const schemaContact = {
  ...
  description:'Contact ELIMFILTERS for technical support, product intelligence, commercial inquiries and distributor opportunities.',
    ...
    <main className="contact-recruit">
      ...
      <section className="cr-section">
        <div className="cr-wrap cr-fit">
          ...
          <div className="cr-list">{copy.fit.map(item=><div key={item}>{item}</div>)}</div>
        </div>
      </section>
      ...
      <section className="cr-section cr-invite">
        <div className="cr-wrap"><div className="cr-invite-box">
          ...
          <div className="cr-actions" style={{marginTop:28}}><Link className="cr-btn cr-btn--primary" href="/distributor-application/" data-conversion-action="distributor-application">{copy.apply}</Link><a className="cr-btn" href="mailto:distribution_network@elimfilters.com?subject=Distributor%20Network%20Inquiry" data-conversion-action="distribution-inquiry">{copy.email}</a></div>
        </div></div>
      </section>
