...
export const metadata: Metadata = {
  ...
  description:
    'Contact ELIMFILTERS® for technical filtration support, OEM cross-references, and ISO-compliant system specification across mining, agriculture, marine, and heavy industry. Response within 2 business days.',
  alternates: {
    canonical: CANONICAL,
    languages: {
      'x-default': CANONICAL,
