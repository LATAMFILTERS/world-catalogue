...
const industryGeoData: Record<string, GeoData> = {
    ...
    faq: [
      {
        ...
        a: 'Passenger and commercial vehicles require air intake protection (MACROCORE™ or SYNTAPORE™), lubrication system protection (SYNTRAX™), fuel system protection, and cabin air quality protection (MICROKAPPA™). Air intake systems must maintain consistent airflow volume across urban particulate exposure and highway speed variation. Lubrication systems must preserve ISO 4406 cleanliness targets through cold-start thermal cycling, short-trip operation, and extended highway intervals. Fuel systems in direct injection engines operating at 150–350 bar injection pressure require particulate and water contamination control to prevent injector erosion and stiction.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Marine diesel engines require fuel and water separation protection (TURBOCORE™), air intake contamination control (MACROCORE™), lubrication cleanliness protection (SYNTRAX™), and hydraulic system protection (NANOFORCE™). Fuel systems on commercial vessels are exposed to water contamination from tank condensation and bunkered fuel quality variation. TURBOCORE™ achieves 99.8% free water removal and 95% emulsified water reduction, protecting common-rail marine injectors from corrosion and stiction failure. Air intake systems must control airborne salinity that causes compressor blade corrosion and increases engine deposit formation rates.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Diesel-electric locomotives require fuel and water separation protection (TURBOCORE™), air intake contamination control (MACROCORE™), lubrication cleanliness protection (SYNTRAX™), and pneumatic system drying (DRYCORE™). Locomotive diesel engines operate at continuous high-load conditions for 12–24 hour haul cycles, accumulating soot in lube oil at rates significantly higher than intermittent-load applications. Fuel stored in locomotive tanks accumulates water through thermal cycling condensation, requiring TURBOCORE™ water separation to maintain injection system cleanliness. Pneumatic braking systems require air dried to dew points below -20°C at system pressure to prevent moisture-related valve and actuator failure.',
      },
      {
    ...
    faq: [
      {
        ...
        a: 'Refuse collection vehicles require lubrication protection (SYNTRAX™), air intake contamination control (MACROCORE™), and fuel system protection (TURBOCORE™). Emergency response vehicles — fire apparatus, ambulances, and rescue units — require the same base protection with particular emphasis on rapid cold-start lubrication performance. Fire apparatus complete 200–400 engine starts per month in short-duration emergency response cycles, with engines returning to cold-standby state between calls. This high cold-start frequency generates fuel dilution and soot accumulation in engine oil at accelerated rates. SYNTRAX™ lubrication protection maintains ISO 4406 cleanliness targets despite frequent cold-start cycling and the short-duration high-load combustion profiles of emergency response operation.',
      },
      {
  ...
  'Agriculture': {
    ...
    faq: [
      ...
      {
        q: 'How does TURBOCORE™ fuel system protection prevent water contamination failure?',
        a: 'TURBOCORE™ is a turbine fuel separator system that removes free and emulsified water from diesel before it reaches high-pressure injection components. Agricultural diesel stored in field tanks accumulates water through condensation, particularly during temperature cycles between day and night operations. TURBOCORE™ achieves 99.8% free water removal and 95% emulsified water reduction, protecting common-rail injectors from corrosion and stiction failure. A water collection bowl with automatic drain prevents bypass during water saturation events.'
      },
      {
