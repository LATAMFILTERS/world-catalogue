  ...
  return (
    <main style={main}>
      ...
      <section style={yellowSection}>
        <div style={wrap}>
          <p style={eyebrow}>PROTECTION LOGIC</p>
          <h2 style={sectionTitle}>Industrial coverage is more than a catalog list.</h2>

          <div style={logicGrid}>
            {[
              'Application-specific contamination profiles',
              'System-level protection logic',
              'Severe-duty operating environments',
              'Cross-reference intelligence',
              'Distributor-ready market structure',
...
const marketTitle: CSSProperties = {
  fontFamily: 'var(--font-display)', fontSize: 'clamp(1.8rem, 3vw, 3.2rem)',
