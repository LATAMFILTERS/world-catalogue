...
const pathGrid: CSSProperties = { display: 'flex', flexWrap: 'wrap', gap: '1px', background: 'rgba(255,255,255,0.08)', marginTop: '2.5rem', border: '1px solid rgba(255,255,255,0.08)' };
const pathCard: CSSProperties = { background: '#050505', padding: '1.5rem', minHeight: '210px', flex: '1 1 190px', minWidth: 0 };
