...
const engineeringPrinciple: CSSProperties = { marginTop: '1.25rem', padding: 'clamp(2.2rem, 4vw, 3.4rem)', minHeight: '190px', borderLeft: '4px solid #FFF12D', background: 'rgba(255,241,45,0.065)', display: 'grid', gridTemplateColumns: 'minmax(190px, 0.34fr) minmax(0, 1.66fr)', gap: 'clamp(2rem, 5vw, 4.5rem)', alignItems: 'center' };
const engineeringPrincipleLabel: CSSProperties = { fontFamily: displayFont, color: '#FFF12D', fontSize: 'clamp(0.78rem, 1.1vw, 0.95rem)', lineHeight: 1.35, fontWeight: 700, letterSpacing: '0.16em', margin: 0 };
const engineeringPrincipleText: CSSProperties = { ...bodyText, color: 'rgba(255,255,255,0.9)', fontSize: 'clamp(1.2rem, 2vw, 1.55rem)', lineHeight: 1.55, fontWeight: 500 };
