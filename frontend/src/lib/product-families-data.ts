...
export const PRODUCT_FAMILIES: Record<FamilyKey, ProductFamily> = {
  ...
  'fuel-water-separators': {
    ...
    protectionSystem: 'fuel-cleanliness',
    primaryTechnology: 'turbocore-series',
    dutyClass: 'HD',
    hdPrefix: 'EF9',
    ldPrefix: null,
    purpose: 'Fuel water separators remove free, emulsified, and dissolved water from diesel fuel in high-volume heavy-duty fuel systems. The TURBOCORE™ FH series provides three-stage water separation for turbine fuel systems in power generation, large-scale mining, and marine applications.',
    engineering: 'Three-stage TURBOCORE™ architecture: Stage 1 — inertial separation via turbine rotation removes free water and coarse particles; Stage 2 — graduated coalescence merges emulsified droplets for gravity separation; Stage 3 — HYDROCORE™ hydrophobic barrier intercepts remaining dissolved water and sub-micron particles. Flow rates: 90 GPH (900FH) and 180 GPH (1000FH).',
    construction: 'DOCUMENTATION PENDING',
