...
const CONTENT: Record<SystemEditorialSlug, SystemEditorial> = {
  ...
  'fuel-cleanliness': {
    ...
    standards: {
      ...
      imageSide: 'right',
      title: 'Selecting and servicing the correct configuration',
      copy: 'Selecting the right configuration starts with confirming the engine, fuel-system architecture and existing filter positions, then identifying whether the application needs particulate control, water separation, or both; required flow and pressure conditions, current fuel quality and storage practices, and service access, drainage and water-monitoring needs all shape the final specification, not just the reference already installed. Fuel flow, particle-efficiency requirement, water-separation requirement, water-holding capacity, pressure drop, fuel temperature and viscosity, and service-interval and drain strategy are the parameters that actually drive the decision, and bulk fuel storage, high humidity and condensation exposure, remote fuel-quality variation, high-hour stationary engines, mining and off-road refueling, and marine or power-generation environments with extended storage each raise the bar differently. The components exposed to that decision are the high-pressure fuel pump, injectors and precision control valves, fuel rails and metering components, transfer pumps, and downstream particulate filters, with combustion stability affected indirectly through fuel quality.\n\nRecurring water in the separator, premature plugging, hard starting or loss of power under load, visible contamination in drained fuel, and shortening service intervals without a duty-cycle change are the signals that justify investigation; a separator and a fuel filter are not the same component and can coexist in the same protection architecture without being interchangeable, and the finest available micron rating is not automatically the right choice once efficiency, flow, pressure drop and capacity are weighed together. The most common mistakes are assuming a finer element automatically improves the system, ignoring water because the engine still runs, using a separator where only particulate filtration is required or vice versa, and selecting by thread or external dimensions without validating flow and architecture. Fuel-filter and water-separation performance claims should remain tied to the applicable validated test basis for the specific product or assembly, since particle control and water separation are separate engineering questions; fuel-cleanliness protection is operationally critical across truck fleets, mining, construction, agriculture, power generation, marine, oil and gas, and waste and municipal fleets, and recurring injector failures, water events, premature plugging or unstable fuel quality justify a full review of the contamination path and filtration stages, not just a cross-reference exercise.',
    },
    industries: {
