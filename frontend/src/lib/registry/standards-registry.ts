...
export const STANDARDS_REGISTRY: Record<string, StandardRecord> = {
  ...
  'STD-ASTM-D6304': {
    ...
    applicableTechnologyIds: ['TECH-HYDROCORE', 'TECH-SYNTEPORE', 'TECH-TURBOCORE'],
  ...
  'STD-ISO-19438': {
    ...
    applicableTechnologyIds: ['TECH-SYNTEPORE', 'TECH-TURBOCORE'],
  ...
  'STD-ISO-16332': {
    ...
    applicableTechnologyIds: ['TECH-HYDROCORE', 'TECH-TURBOCORE'],
    applicableEngineeringPrincipleIds: ['EP-PHS-001', 'EP-PHS-002'],
    maturity: MATURITY.PUBLISHED,
    createdDate: '2026-07-01',
    versionHistory: [
