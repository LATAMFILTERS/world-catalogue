...
export const PEP_FAMILIES: PEPFamily[] = [
  ...
  },
  {
    ...
    engineering: 'SYNTEPORE™ provides high-efficiency filtration at system fuel flow rates. Designed to remove fine particles that survive primary and separator stages. Target fuel cleanliness at ISO 12/10/8 for HPCR injector protection at 1,600–2,500 bar injection pressure.',
