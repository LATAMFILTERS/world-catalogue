...
export const PROTECTION_SYSTEMS: Record<ProtectionSystemKey, ProtectionSystem> = {
  ...
  'fuel-cleanliness': {
    ...
    engineeringPrinciple: 'Staged particle filtration is combined with coalescence and hydrophobic separation. SYNTEPORE™ controls particulate contamination while AQUAGUARD™ addresses free and emulsified water in fuel-water separation applications.',
    heroImage: '/images/fuellseparator-hero.avif',
    heroColor: '#FFF12D',
    primaryTechnologies: ['syntepore', 'aquaguard'],
