...
export const STANDARDS: StandardRecord = {
  ISO_16889: {
    ...
    slug: 'iso-16889',
    applicableTo: ['MACROCORE', 'NANOFORCE', 'MICROKAPPA', 'TURBOCORE', 'DURATECH'],
  ...
  ASTM_D6304: {
    ...
    slug: 'astm-d6304',
    applicableTo: ['NANOFORCE', 'TURBOCORE', 'SYNTRAX'],
...
export const CONTAMINATION_MODES: ContaminationRecord = {
  DIESEL_WATER: {
    ...
    resolvedBy: ['NANOFORCE', 'TURBOCORE', 'SYNTRAX'],
  ...
  HYDRAULIC_CONTAMINATION: {
    ...
    resolvedBy: ['NANOFORCE', 'TURBOCORE', 'SYNTRAX', 'MICROKAPPA'],
...
export const INDUSTRIES: IndustryRecord = {
  ...
  MARINE: {
    ...
    applicableTechnologies: ['NANOFORCE', 'TURBOCORE', 'DURATECH', 'SYNTRAX'],
  ...
  POWER_GENERATION: {
    ...
    relevantContamination: ['DIESEL_WATER', 'PARTICLE_WEAR'],
    applicableTechnologies: ['MACROCORE', 'NANOFORCE', 'TURBOCORE', 'SYNTRAX'],
...
export const COMPARISON_TOPICS = {
  OEM_VS_AFTERMARKET: {
    ...
    relevantTechnologies: ['MACROCORE', 'NANOFORCE', 'MICROKAPPA', 'DURATECH', 'TURBOCORE'],
    coverageAreas: [
...
export function getAllTechnologiesByFeature(feature: 'waterRemoval' | 'particleCapture' | 'wearProtection' | 'costEffective') {
  const features = {
    waterRemoval: ['NANOFORCE', 'TURBOCORE', 'SYNTRAX'],
