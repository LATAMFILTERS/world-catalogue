...
export const KC_TECHNOLOGIES: KCTechnology[] = [
  ...
  },
  {
    slug: 'turbocore',
    name: 'TURBOCORE™',
    domain: 'Fuel Cleanliness Protection — Three-Stage',
    tagline: 'Three-stage heavy-duty fuel filter/water separator for full-spectrum diesel contamination control.',
    engineeringPrinciple: 'TURBOCORE™ addresses the full diesel fuel contamination spectrum in sequence: Stage 1 uses HYDROCORE™ inertial rotation for coarse particle capture and initial water separation; Stage 2 provides coalescing media for emulsified water aggregation and gravity separation; Stage 3 is a final hydrophobic barrier preventing water carry-over to HPCR injectors. The three-stage sequence operates independently of fuel flow rate and back-pressure variations. Validated to ISO 16332 for water separation efficiency ≥99% and designed for high-flow-rate diesel systems (90–180 GPH) in power generation, mining, agriculture, and heavy transport.',
    contamination: ['Free water in diesel fuel', 'Emulsified water', 'Particulate contamination', 'Microbial growth', 'Wax and asphaltene deposits'],
    performanceSpecs: [
      { label: 'Water separation efficiency (ISO 16332)', value: '≥99%' },
      { label: 'Flow range', value: '90–180 GPH' },
      { label: 'Stage count', value: '3-stage (inertia + coalescence + barrier)' },
      { label: 'Models', value: 'FH 900FH · FH 1000FH' },
    ],
    standards: ['ISO 16332', 'ASTM D6304'],
    relatedSystems: ['fuel-cleanliness-protection'],
    relatedIndustries: ['power-generation', 'mining', 'agriculture', 'truck-fleets', 'construction', 'marine'],
    worksWith: ['HYDROCORE™', 'SYNTEPORE™'],
  },
  {
    slug: 'thermacore',
    name: 'THERMACORE™',
