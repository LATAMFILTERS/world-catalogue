...
export const GLOSSARY_REGISTRY: Record<string, TerminologyEntry> = {
  ...
  'TERM-MICROBIAL-CONTAMINATION': {
    ...
    relatedTechnologies: ['TURBOCORE', 'marineclean'],
    relatedSystems: ['fuel-cleanliness-protection'],
  ...
  'TERM-EMULSIFIED-WATER': {
    ...
    engineeringContext:
      'Modern ultra-low-sulphur diesel (ULSD) is less tolerant of water contamination than legacy high-sulphur diesel because ULSD contains fewer natural surfactants. Water entering ULSD through storage tank condensation or cross-contamination rapidly forms fine, stable emulsions that pass through conventional filter media without separation. Coalescing filter technology — TURBOCORE — is specifically engineered to break and remove ULSD emulsions before fuel contacts HPCR injection components with precision internal clearances.',
  ...
  'TERM-WATER-SEPARATION-EFFICIENCY': {
    ...
    engineeringContext:
      'Water separation efficiency governs the residual water concentration achievable in fuel downstream of the filter assembly under rated operating conditions. For HPCR injection systems requiring low water content at the injector inlet in high-humidity or contaminated-fuel environments, the coalescing element must be rated for the required grade. TURBOCORE staged fuel-conditioning and separation is engineered around sequential mechanisms — coalescing droplets, gravity settling, and hydrophobic repulsion of residual fine droplets — matched to the approved application.',
  ...
  'TERM-MELT-BLOWN-MEDIA': {
    ...
    relatedTechnologies: ['TURBOCORE', 'turbocore', 'microkappa', 'nanoforce'],
