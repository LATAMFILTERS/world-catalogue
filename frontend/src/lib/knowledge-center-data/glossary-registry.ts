...
export const GLOSSARY_REGISTRY: Record<string, TerminologyEntry> = {
  ...
  'TERM-WATER-INGRESS': {
    ...
    relatedTechnologies: ['TURBOCORE', 'SYNTAPORE'],
  ...
  'TERM-EMULSIFIED-WATER': {
    ...
    engineeringContext:
      'Modern ultra-low-sulphur diesel (ULSD) is less tolerant of water contamination than legacy high-sulphur diesel because ULSD contains fewer natural surfactants. Water entering ULSD through storage tank condensation or cross-contamination rapidly forms fine, stable emulsions that pass through conventional filter media without separation. Coalescing filter technology — TURBOCORE and TURBOCORE three-stage systems — is specifically engineered to break and remove ULSD emulsions before fuel contacts HPCR injection components rated to tolerances of 1–3 µm and clearances of 1–2 µm.',
    ...
    relatedTechnologies: ['TURBOCORE', 'turbocore', 'SYNTAPORE'],
    relatedSystems: ['fuel-cleanliness-protection'],
