...
- **Technology nodes**: MACROCORE, NANOFORCE, SYNTRAX, SYNTEPORE, HYDROCORE, INTEKCORE, MICROKAPPA — all present ✓
...
- `in_unified_data: true` with `ud_key`: AGRICULTURE, ASTM_D6304, AUTOMOTIVE, BUS_COACH, CABIN_AIR_CONTAMINATION, CONSTRUCTION, DIESEL_WATER, DUST_INGESTION, HYDRAULIC_CONTAMINATION, HYDROCORE, INTEKCORE, ISO_11155, ISO_12937, ISO_16889, ISO_4406, ISO_5011, MACROCORE, MARINE, MICROKAPPA, MINING, NANOFORCE, OIL_GAS, PARTICLE_WEAR, POWER_GENERATION, RAILWAY, SAE_J1539, SYNTEPORE, SYNTRAX, TRUCKS_FLEETS, WASTE_MUNICIPAL — all include `ud_key`.
