...
const { installProtocolGreeting } = require('./bot-protocol-greeting');
const { installProtocolSymptomNormalizer } = require('./bot-protocol-symptom-normalizer');
const { installProtocolIntelligence } = require('./bot-protocol-intelligence');
const { installProtocolRouting } = require('./bot-protocol-routing');
const { installCatalogResolver } = require('./bot-protocol-catalog-resolver');
...
function wrappedExpress(...args) {
  ...
  installProtocolGreeting(app);
  installProtocolSymptomNormalizer(app);
  installProtocolIntelligence(app);
  installProtocolRouting(app);
  installInstalledFilterStep(app);
  installCatalogResolver(app);
