...
function inferTechnology(product = {}) {
  ...
  // isTurbineHousingSignal) always means TURBOCORE™, independent of whether
  // filter_type happens to say "fuel"/"water" in the same words a generic
  // separator would use.
  ...
  if (isFuelWaterSeparator || /fuel|diesel|combustible/.test(type)) return 'SYNTAPORE™';
