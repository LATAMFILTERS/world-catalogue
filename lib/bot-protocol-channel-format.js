...
function allowedOemManufacturers(equipment = {}) {
  ...
  // Mack and Volvo share truck/engine families. For a Mack application,
  // only Mack/Volvo OEM references are authoritative unless the recorded
  // engine explicitly identifies another manufacturer.
