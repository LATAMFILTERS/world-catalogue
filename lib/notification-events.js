...
module.exports = {
  ...
  deployFailure: (title, message, context) => emit('DEPLOY_FAILURE','RUNTIME','CRITICAL',title,message,context),
  rollback: (title, message, context) => emit('ROLLBACK','RUNTIME','HIGH',title,message,context),
};
