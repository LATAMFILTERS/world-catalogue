...
async function processQuery(message, context = {}) {
  ...
  if (intent === 'application_lookup' && !year) {
    return {
      protocol_version: '1.2.1', intent, phase: 'collecting_application_data', plan,
  ...
  return {
    protocol_version: '1.2.1', intent, phase: 'catalog_resolution', plan,
