...
async function consolidateAndDelete() {
    ...
    try {
        ...
        for (const nombreCol of coleccionesOrigen) {
            try {
                ...
                if (total === 0) {
                    console.log(`⏭️  Saltando ${nombreCol} (vacía)\n`);
                    continue;
                }
                ...
                for await (const doc of cursor) {
                    ...
                    if (batch.length >= 100) {
                        ...
                        if (procesados % 1000 === 0) {
                            console.log(`  ✅ Procesados ${procesados}/${total}...`);
                        }
                    }
                }
                ...
                // 🔥 BORRAR LA COLECCIÓN ORIGEN INMEDIATAMENTE
                await origen.drop();
                console.log(`  🗑️  ${nombreCol} ELIMINADA - Espacio liberado\n`);
