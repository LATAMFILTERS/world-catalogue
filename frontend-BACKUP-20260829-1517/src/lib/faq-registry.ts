...
// Each demand-led answer points to the narrowest first-party technical source
// available so FAQ answers remain retrievable, auditable and entity-grounded.
...
const SEARCH_DEMAND_FAQS: readonly FAQRegistryEntry[] = [
  {
    ...
    sourceHref: '/knowledge-center/glossary/iso-cleanliness-code/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    id: 'gsc-iso-4406-chart',
    category: 'Engineering fundamentals',
    topic: 'ISO 4406 cleanliness chart',
    question: 'What is an ISO 4406 cleanliness chart?',
    answer: 'An ISO 4406 cleanliness chart maps particle-count ranges to the three cleanliness code numbers used to describe fluid contamination. It is a reference for interpreting measured particle counts; the acceptable cleanliness target still depends on the protected equipment, component sensitivity and operating requirement.',
    sourceHref: '/knowledge-center/diagrams/iso-4406-cleanliness-scale/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    id: 'gsc-iso-8573-1',
    category: 'Compressed air fundamentals',
    topic: 'ISO 8573-1',
    question: 'What is ISO 8573-1?',
    answer: 'ISO 8573-1 is a compressed-air purity classification standard that defines classes for major contaminant categories. The required purity class is application-specific and should be selected from the process, equipment and air-quality requirement rather than treated as a universal filtration target.',
    sourceHref: '/knowledge-center/standards/iso-8573-1/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/differential-pressure/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/service-interval/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/soot/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/depth-filtration/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/coalescing/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/bearing-clearance/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/hydrodynamic-lubrication/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/microbial-contamination/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
  {
    ...
    sourceHref: '/knowledge-center/glossary/nas-cleanliness-code/',
    sourceType: 'search-demand',
    demandSignal: 'gsc-observed',
    lastReviewed: REVIEW_DATE,
  },
