...
export const GLOSSARY_REGISTRY: Record<string, TerminologyEntry> = {
  ...
  'TERM-EMULSIFIED-WATER': {
    ...
    engineeringContext:
      'Modern ultra-low-sulphur diesel (ULSD) is less tolerant of water contamination than legacy high-sulphur diesel because ULSD contains fewer natural surfactants. Water entering ULSD through storage tank condensation or cross-contamination rapidly forms fine, stable emulsions that pass through conventional filter media without separation. Coalescing filter technology — HYDROCORE — is specifically engineered to break and remove ULSD emulsions before fuel contacts HPCR injection components with precision internal clearances.',
  ...
  'TERM-MELT-BLOWN-MEDIA': {
    ...
    relatedTechnologies: ['HYDROCORE', 'microkappa', 'nanoforce'],
